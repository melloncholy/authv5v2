<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="ml-1 btn btn-primary" href="{{ url('auth/google') }}" style="margin-top: 0px !important;background: red;color: #ffffff;padding: 5px;border-radius:7px;" id="btn-glogin">
